...
function App() {
  ...
  const isAuthPage = activePage === 'landing' || activePage === 'signin'
    ...
    <div className={isDarkMode ? 'dark' : ''}>
      {isAuthPage ? (
        ...
        <div className="flex h-screen bg-wellness-gray dark:bg-gray-900 transition-colors duration-300 overflow-hidden font-sans text-wellness-text dark:text-gray-100">
          ...
          {/* Desktop sidebar — hidden on mobile via hidden lg:flex inside Sidebar */}
          <Sidebar {...sharedNavProps} />

          {/* Main content — extra bottom padding on mobile to clear the bottom nav */}
          <main className="flex-1 overflow-y-auto p-8 lg:p-12 pb-24 lg:pb-12 relative">
