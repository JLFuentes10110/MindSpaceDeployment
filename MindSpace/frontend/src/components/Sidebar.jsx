...
const Sidebar = ({ activePage, setActivePage, isDarkMode, setIsDarkMode, onSignOut }) => {
    ...
    return (
        ...
        <div className="hidden lg:flex w-[280px] bg-white dark:bg-gray-800 transition-colors duration-300 h-screen border-r border-gray-50 dark:border-gray-700/50 flex-col pt-10 pb-8 px-6 shadow-[10px_0_40px_rgba(0,0,0,0.02)] z-10 relative">
