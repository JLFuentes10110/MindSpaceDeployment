...
const ReflectionPage = ({ onUnauthorized }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto flex flex-col py-4 pb-8">
            ...
            <div className="card bg-white/90 dark:bg-gray-800/90 transition-colors duration-300 backdrop-blur-xl shadow-[0_15px_60px_rgba(0,0,0,0.03)] dark:shadow-none border-0 px-6 py-8 sm:px-8 sm:py-10">

                {/* Prompt selector */}
                <div className="mb-6">
                    <label className="block text-[14px] font-semibold text-gray-400 tracking-wide uppercase mb-3 ml-1">
                        Choose a prompt
                    </label>
                    <div className="relative">
                        <select
                            ...
                            className="w-full appearance-none bg-gray-50/50 dark:bg-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-[1.5rem] px-6 py-4 text-gray-700 dark:text-gray-200 outline-none focus:ring-4 focus:ring-blue-100/50 dark:focus:ring-blue-900/50 focus:border-blue-200 dark:focus:border-blue-700 transition-all font-medium pr-10 text-[15px] cursor-pointer"
                        >
                            {prompts.map((p, i) => (
                ...
                <div className="mb-6">
                    <textarea
                        ...
                        rows={6}
                        className="w-full bg-[#fcfdff] dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600 rounded-[2rem] p-6 outline-none focus:ring-4 focus:ring-blue-100/40 dark:focus:ring-blue-900/40 focus:border-blue-200 dark:focus:border-blue-700 transition-all resize-none text-gray-700 dark:text-gray-200 text-[16px] leading-[1.8] shadow-inner dark:shadow-none placeholder-gray-300 dark:placeholder-gray-500"
                    />
                </div>

                {/* Footer row */}
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-50 dark:border-gray-700/50 pt-6">
                    <div className="h-8 flex items-center">
                        {showConfirmation && (
                            <span className="text-green-600 dark:text-green-400 font-semibold text-[14px] flex items-center gap-2 bg-green-50/80 dark:bg-green-900/30 px-4 py-2 rounded-full border border-green-100/50 dark:border-green-800/50 shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <button
                        ...
                        className={`w-full sm:w-auto px-10 py-4 rounded-full font-semibold transition-all duration-300 ${
                            reflectionText.trim()
